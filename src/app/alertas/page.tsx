...
const alertBadgeColors = {
  quiebre: "destructive" as const,
  stock_critico: "secondary" as const,
  oportunidad: "default" as const,
  sugerido_compra: "outline" as const,
};
...
const alertTitles = {
  ...
  sugerido_compra: "Sugeridos de Compra",
};
    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground text-sm mt-1">
          {alertas.length} alertas activas que requieren atención
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <Card
          className={`cursor-pointer transition-all ${
            selectedType === "quiebre" ? "ring-2 ring-red-500" : ""
          }`}
        ...
        <Card
          className={`cursor-pointer transition-all ${
            selectedType === "stock_critico" ? "ring-2 ring-orange-500" : ""
          }`}
          onClick={() =>
            setSelectedType(selectedType === "stock_critico" ? "all" : "stock_critico")
          }
        >
          <CardContent className="pt-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-orange-600">
                  {alertasPorTipo.stock_critico.length}
                </p>
        ...
        <Card
          className={`cursor-pointer transition-all ${
            selectedType === "oportunidad" ? "ring-2 ring-green-500" : ""
          }`}
          onClick={() =>
            setSelectedType(selectedType === "oportunidad" ? "all" : "oportunidad")
          }
        >
          <CardContent className="pt-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-green-600">
                  {alertasPorTipo.oportunidad.length}
                </p>
        ...
        <Card
          className={`cursor-pointer transition-all ${
            selectedType === "sugerido_compra" ? "ring-2 ring-blue-500" : ""
          }`}
          onClick={() =>
            setSelectedType(selectedType === "sugerido_compra" ? "all" : "sugerido_compra")
          }
        >
          <CardContent className="pt-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-blue-600">
                  {alertasPorTipo.sugerido_compra.length}
                </p>
      ...
      <div className="flex gap-2 mb-6 flex-wrap">
        ...
        <Button
          variant={selectedType === "quiebre" ? "default" : "outline"}
          size="sm"
          onClick={() => setSelectedType("quiebre")}
          className="text-red-600 border-red-200 hover:bg-red-50"
        >
          Quiebres ({alertasPorTipo.quiebre.length})
        </Button>
        <Button
          variant={selectedType === "stock_critico" ? "default" : "outline"}
          size="sm"
          onClick={() => setSelectedType("stock_critico")}
          className="text-orange-600 border-orange-200 hover:bg-orange-50"
        >
          Críticos ({alertasPorTipo.stock_critico.length})
        </Button>
        <Button
          variant={selectedType === "oportunidad" ? "default" : "outline"}
          size="sm"
          onClick={() => setSelectedType("oportunidad")}
          className="text-green-600 border-green-200 hover:bg-green-50"
        >
          Oportunidades ({alertasPorTipo.oportunidad.length})
        </Button>
        <Button
          variant={selectedType === "sugerido_compra" ? "default" : "outline"}
          size="sm"
          onClick={() => setSelectedType("sugerido_compra")}
          className="text-blue-600 border-blue-200 hover:bg-blue-50"
        >
          Sugeridos ({alertasPorTipo.sugerido_compra.length})
        </Button>
      </div>
